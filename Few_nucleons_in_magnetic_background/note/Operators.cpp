...
double Operators::SpinOp(std::vector<int> sz1, std::vector<int> sz2, int i, int j, VectorXi Perm, int kind)
{
	...
	if (kind == 3)	return O_0(sz1[i], sz1[j], sz2[Perm(i)], sz2[Perm(j)]);
        ...
        if (kind == 5)	return O_5s(sz1[i], sz1[j], sz2[Perm(i)], sz2[Perm(j)]);  //magnetic operator
}
...
double Operators::IsospinOp(std::vector<int> tz1, std::vector<int> tz2, int i, int j, VectorXi Perm, int kind)
{
	...
	if (kind == 3)	return O_1(tz1[i], tz1[j], tz2[Perm(i)], tz2[Perm(j)]);
        ...
        if (kind == 5)	return O_5i(tz1[i], tz1[j], tz2[Perm(i)], tz2[Perm(j)]); //magnetic operator
}
...
double Operators::O_5s(int i1, int i2, int i3, int i4) //permutation operator
{
	//	1 for spin up
	//	2 for spin down
	double x = 0;
...
double Operators::O_5i(int i1, int i2, int i3, int i4) //permutation operator
{
	//	1 for proton g_p=5.586
	//	2 for netron g_n=-3.826
	double x = 0;
	if ((i1 == i3) && (i2 == i4))
           {
                 if ((i3 == 1) && (i4 == 1))  x = 11.172;
                 if ((i3 == 2) && (i4 == 2))  x = -7.652;
                 if ((i3 == 2) && (i4 == 1))  x = 1.76;
                 if ((i3 == 1) && (i4 == 2))  x = 1.76;
           } 
	return x;
